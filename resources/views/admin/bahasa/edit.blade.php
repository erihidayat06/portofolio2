...
@section('content')
    <div class="container mt-5">
        <div class="card">
            <div class="card-header fw-bold">Edit Bahasa Pemrograman</div>
            <div class="card-body">
                <form action="{{ route('bahasa.update', $bahasa->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                            name="nama" value="{{ old('nama', $bahasa->nama) }}">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <div id="preview" class="d-flex mt-2 gap-2 flex-wrap">
                            @if ($bahasa->gambar)
                                <img src="{{ asset('storage/' . $bahasa->gambar) }}" class="rounded shadow-sm"
